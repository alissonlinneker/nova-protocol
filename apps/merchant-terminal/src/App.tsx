...
type Tab = "dashboard" | "terminal" | "feed" | "analytics" | "settings";
...
export default function App() {
  ...
  // Start polling and WebSocket on mount, clean up on unmount
  useEffect(() => {
    startPolling();
    connectWs();
      ...
      <header className="border-b border-gray-800/50 bg-gray-950/90 backdrop-blur-xl sticky top-0 z-30">
        <div className="max-w-5xl mx-auto px-4 py-4 flex items-center justify-between">
          ...
          <div className="flex items-center gap-2">
            <span className={`w-2 h-2 rounded-full ${nodeConnected ? "bg-emerald-400 animate-pulse" : "bg-red-400"}`} />
            <span className={`text-xs font-medium ${nodeConnected ? "text-emerald-400" : "text-red-400"}`}>
